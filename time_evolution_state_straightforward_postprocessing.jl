...
file_name = "data - wavepacket as state/test_wavepacket_right_moving_gs_mps_wo_symmetries_trunc_$(truncation)_mass_$(mass)_v_$(v)_Delta_g_$(Delta_g)_N_$(N)_k_$(k)_sigma_$(sigma)_dt_$(dt)_tend_$(t_end)"

if !(bogoliubov)
    file_name = file_name * "_no_bogoliubov"
end
