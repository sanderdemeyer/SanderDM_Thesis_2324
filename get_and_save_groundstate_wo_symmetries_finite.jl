...
N = 20
D = 5
mps = FiniteMPS(fill(ℂ^2, N), fill(ℂ^D, N-1))
...
@save "SanderDM_Thesis_2324/gs_mps_wo_symmetries_finite_N_$(N)_trunc_$(trunc)_mass_$(mass)_v_$(v)_Delta_g_$(Delta_g)" mps envs
