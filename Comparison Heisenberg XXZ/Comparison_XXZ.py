...
delta_gs_refined = np.linspace(-2,6,amount*10)
...
plt.scatter(delta_gs, energies_XXZ_dyn_4, label = 'own data, dynamic, trunc = 4')
plt.plot(delta_gs_refined, [analytical(-e) for e in delta_gs_refined], label = 'analytical solution')
